                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalBody">
                        ...
                        <div class="form-group">
                            <label for="user_logname" class="col-sm-2 control-label">部门名</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="deptName" id="user_logname" placeholder="请输入部门名">
                            </div>
                        </div>
                        </form>
...
<script src="${pageContext.request.contextPath}/js/feedback/forDeptList.js"></script>
</body>
</html>